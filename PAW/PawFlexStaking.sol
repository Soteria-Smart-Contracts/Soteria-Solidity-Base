...
contract FlexibleStaking{
    ...
    function Claim() public returns(bool success){
        ...
        require((ERC20(wPAW).balanceOf(address(this)) - Unclaimed) >= TotalDeposits, "The contract does not have enough PAW to pay profits at the moment"); //This exists as protection in the case that the contract has not been refilled with PAW in time
        Update(msg.sender);
